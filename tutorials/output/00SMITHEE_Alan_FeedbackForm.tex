...
{\Large\bf \fbox{Note: 2.75/5}}\end{center}

\vspace*{-0.7cm}\hfill Classe:  $\left(2.8 \pm 1.2\right)$/5
\noindent\rule{\linewidth}{.7pt}\begin{center}{\large\bf Détail de la note}\end{center}

\begin{center}
\includegraphics[keepaspectratio, width=\linewidth]{/home/abigot/effm/tutorials/output/SMITHEE_Alan_GradeStats.pdf}\end{center}
